...
class HondaCivicDetailPage extends StatefulWidget {
  HondaCivicDetailPage({Key? key}) : super(key: key);

  @override
  State<HondaCivicDetailPage> createState() => _HondaCivicDetailPageState();
}

class _HondaCivicDetailPageState extends State<HondaCivicDetailPage> {
  @override
      ...
      body: Stack(children: [
        ...
        Positioned(
          ...
          child: Container(
            width: 275,
            child: Image.network(
                "https://www.motortrend.com/uploads/sites/10/2021/11/2022-honda-civic-sport-sedan-angular-front.png"),
          ),
        ),
        Positioned(
          top: 365,
