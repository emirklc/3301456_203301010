...
class RenaultClioDetailPage extends StatefulWidget {
  RenaultClioDetailPage({Key? key}) : super(key: key);

  @override
  State<RenaultClioDetailPage> createState() => _RenaultClioDetailPageState();
}

class _RenaultClioDetailPageState extends State<RenaultClioDetailPage> {
  @override
      ...
      body: Stack(children: [
        ...
        Positioned(
          ...
          child: Container(
            width: 275,
            child: Image.network(
                "https://www.arackiralamasamsun.com/kullanici/icerik/icerik_resimleri/kucuk/jetta-e6318-kurtarildi-c5342.png"),
          ),
        ),
        Positioned(
          top: 375,
